...
const CitizenProblemDetailModal = lazy(() => import("../components/CitizenProblemDetailModal"));
  ...
  return (
    <div className="flex flex-col h-screen bg-background">
              ...
              <div className="absolute bottom-24 left-4 right-4 z-20 animate-fade-in-up sm:right-24">
                <div className="relative">
                  <button
                    ...
                    className="absolute -top-2 -right-2 w-6 h-6 rounded-full bg-foreground text-background flex items-center justify-center text-xs z-10 font-bold shadow-md"
                    aria-label="Fechar"
                  >×</button>
      ...
      <Suspense fallback={null}>
        ...
        {detailProblem && (
          <CitizenProblemDetailModal problem={detailProblem} onClose={() => setDetailProblem(null)} />
        )}
      </Suspense>
    </div>
  );
